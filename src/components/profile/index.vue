	...
	<div class="profile">
		...
		<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 				style="position:absolute;width:0;height:0">
			<defs>
				...
				<symbol viewBox="0 0 40 40" id="vip">
					...
					<path d="M32.1 14.3c-.6 2.3-2.6 4-5.1 4-2.9 0-5.3-2.3-5.3-5.2v-.2c-.5.2-1 .3-1.6.3-.6 0-1.1-.1-1.7-.3v.2c0 2.9-2.4 5.2-5.3 5.2-2.5 0-4.6-1.7-5.1-4.1-.5.4-1.2.6-1.8.6-.3 0-.5.1-.8 0L7.2 29h26l1.7-14.2c-.3.1-.5.1-.8.1-.8 0-1.5-.2-2-.6z"
					 class="st0"></path>
				...
				<symbol viewBox="0 0 16 16" id="point">
					<g fill="none" fill-rule="evenodd">
						<path fill="#FFF" fill-opacity="0" d="M0 0h16v16H0z"></path>
				...
				<symbol xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 109.08 68.64" id="crown">
					<defs>
						<filter id="crown_luminosity-noclip" width="7.74" height="32766" x="50.94" y="-8579.57" color-interpolation-filters="sRGB"
						...
						<filter id="crown_luminosity-noclip-2" width="73.05" height="32766" x="6.98" y="-8579.57" color-interpolation-filters="sRGB"
						 filterUnits="userSpaceOnUse">
							<feFlood flood-color="#fff" result="bg"></feFlood>
							<feBlend in="SourceGraphic" in2="bg"></feBlend>
						</filter>
						<linearGradient id="crown_未命名的渐变_10-2" x1="65.61" x2="16.96" y1="87.25" y2="36.98" xlink:href="#crown_未命名的渐变_10"></linearGradient>
						<filter id="crown_luminosity-noclip-3" width="45.27" height="32766" x="54.15" y="-8579.57" color-interpolation-filters="sRGB"
						 filterUnits="userSpaceOnUse">
							<feFlood flood-color="#fff" result="bg"></feFlood>
							<feBlend in="SourceGraphic" in2="bg"></feBlend>
						</filter>
						<linearGradient id="crown_未命名的渐变_10-3" x1="51.25" x2="74.57" y1="23.43" y2="38.06" xlink:href="#crown_未命名的渐变_10"></linearGradient>
						<filter id="crown_luminosity-noclip-4" width="7.74" height="32766" x="101.34" y="-8579.57" color-interpolation-filters="sRGB"
						 filterUnits="userSpaceOnUse">
							<feFlood flood-color="#fff" result="bg"></feFlood>
							<feBlend in="SourceGraphic" in2="bg"></feBlend>
						</filter>
						<linearGradient id="crown_未命名的渐变_10-4" x1="101.54" x2="108.83" y1="19.32" y2="21.93" xlink:href="#crown_未命名的渐变_10"></linearGradient>
						<filter id="crown_luminosity-noclip-5" width="7.74" height="32766" x="1.33" y="-8579.57" color-interpolation-filters="sRGB"
						 filterUnits="userSpaceOnUse">
							<feFlood flood-color="#fff" result="bg"></feFlood>
							<feBlend in="SourceGraphic" in2="bg"></feBlend>
						</filter>
						<linearGradient id="crown_未命名的渐变_10-5" x1="1.79" x2="8.81" y1="19.03" y2="22.3" xlink:href="#crown_未命名的渐变_10"></linearGradient>
						<filter id="crown_luminosity-noclip-6" width="94.33" height="32766" x="6.98" y="-8579.57" color-interpolation-filters="sRGB"
						 filterUnits="userSpaceOnUse">
							<feFlood flood-color="#fff" result="bg"></feFlood>
							<feBlend in="SourceGraphic" in2="bg"></feBlend>
						</filter>
						...
						<filter id="crown_luminosity-noclip-7" width="73.05" height="32766" x="28.26" y="-8579.57" color-interpolation-filters="sRGB"
						 filterUnits="userSpaceOnUse">
							<feFlood flood-color="#fff" result="bg"></feFlood>
							<feBlend in="SourceGraphic" in2="bg"></feBlend>
						</filter>
						<linearGradient id="crown_未命名的渐变_10-6" x1="49.8" x2="88.75" y1="78.84" y2="42.23" xlink:href="#crown_未命名的渐变_10"></linearGradient>
						<filter id="crown_luminosity-noclip-8" width="7.74" height="7.74" x="50.94" y="1.33" color-interpolation-filters="sRGB"
						 filterUnits="userSpaceOnUse">
							<feFlood flood-color="#fff" result="bg"></feFlood>
							<feBlend in="SourceGraphic" in2="bg"></feBlend>
						</filter>
						...
						<filter id="crown_luminosity-noclip-9" width="7.74" height="7.74" x="101.34" y="16.95" color-interpolation-filters="sRGB"
						 filterUnits="userSpaceOnUse">
							<feFlood flood-color="#fff" result="bg"></feFlood>
							<feBlend in="SourceGraphic" in2="bg"></feBlend>
						</filter>
						...
						<filter id="crown_luminosity-noclip-10" width="7.74" height="7.74" x="1.33" y="16.95" color-interpolation-filters="sRGB"
						 filterUnits="userSpaceOnUse">
							<feFlood flood-color="#fff" result="bg"></feFlood>
							<feBlend in="SourceGraphic" in2="bg"></feBlend>
						</filter>
						...
						<linearGradient id="crown_未命名的渐变_152-3" x1="3295.54" x2="3376.27" y1="39.61" y2="39.61" gradientTransform="matrix(-1 0 0 1 3394.5 0)"
						 xlink:href="#crown_未命名的渐变_152"></linearGradient>
						<linearGradient id="crown_未命名的渐变_152-4" x1="3313.44" x2="3376.27" y1="39.6" y2="39.6" gradientTransform="matrix(-1 0 0 1 3394.5 0)"
						 xlink:href="#crown_未命名的渐变_152"></linearGradient>
						<filter id="crown_luminosity-noclip-11" width="94.33" height="55.97" x="6.98" y="12.66" color-interpolation-filters="sRGB"
						 filterUnits="userSpaceOnUse">
							<feFlood flood-color="#fff" result="bg"></feFlood>
							<feBlend in="SourceGraphic" in2="bg"></feBlend>
						</filter>
						<mask id="crown_mask-11" width="94.33" height="55.97" x="6.98" y="12.66" maskUnits="userSpaceOnUse">
							<g class="cls-11">
								<path d="M99.47 26.05l-21 11.89a1.87 1.87 0 0 1-2.34-.41l-20.9-24.37a1.42 1.42 0 0 0-2.16 0L32.19 37.52a1.87 1.87 0 0 1-2.34.41l-21-11.89A1.23 1.23 0 0 0 7 27.33l5.78 34.77.66 4a3.07 3.07 0 0 0 3 2.57h75.39a3.07 3.07 0 0 0 3-2.57l.66-4 5.78-34.78a1.23 1.23 0 0 0-1.8-1.27z"
								 class="cls-12"></path>
							</g>
						</mask>
						...
						<filter id="crown_luminosity-noclip-12" width="73.05" height="42.75" x="28.26" y="25.89" color-interpolation-filters="sRGB"
						 filterUnits="userSpaceOnUse">
							<feFlood flood-color="#fff" result="bg"></feFlood>
							<feBlend in="SourceGraphic" in2="bg"></feBlend>
						</filter>
						<mask id="crown_mask-12" width="73.05" height="42.75" x="28.26" y="25.89" maskUnits="userSpaceOnUse">
							<g class="cls-13">
								<path d="M99.47 26.05l-17.38 9.83-53.83 32.76h63.57a3.07 3.07 0 0 0 3-2.57l.66-4 5.78-34.78a1.23 1.23 0 0 0-1.8-1.24z"
								 class="cls-14"></path>
							</g>
						</mask>
						<linearGradient id="crown_未命名的渐变_6-4" x1="49.8" x2="109.62" y1="78.84" y2="22.62" xlink:href="#crown_未命名的渐变_6"></linearGradient>
						<filter id="crown_luminosity-noclip-13" width="73.05" height="42.75" x="6.98" y="25.89" color-interpolation-filters="sRGB"
						 filterUnits="userSpaceOnUse">
							<feFlood flood-color="#fff" result="bg"></feFlood>
							<feBlend in="SourceGraphic" in2="bg"></feBlend>
						</filter>
						...
						<filter id="crown_luminosity-noclip-14" width="45.27" height="40.18" x="54.15" y="12.66" color-interpolation-filters="sRGB"
						 filterUnits="userSpaceOnUse">
							<feFlood flood-color="#fff" result="bg"></feFlood>
							<feBlend in="SourceGraphic" in2="bg"></feBlend>
						</filter>
		...
		<div class="profile-content">
			<div class="profile-icon">
				<img :src="getImage(profileInfo.user.image_hash , '?imageMogr/format/webp/thumbnail/!198.72000000000003x198.72000000000003r/gravity/Center/crop/198.72000000000003x198.72000000000003/')">
			</div>
			<div class="profile-info">
				<div @click="isLogin ? setUserInfo() : toLogin()">
		...
		<router-link class="link-item" v-for="item in profileInfo.list" :to="item.url" :key="item.id" :style="{marginTop:item.marginTop}">
...
export default {
	...
	methods: {
		loadData () {
			this.$http.get('/ele/profile').then(res => {
				this.profileInfo.user = res.data;
			}).catch( () => {
